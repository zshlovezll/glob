...
function addComment(request, response) {
    ...
    commentDao.insertComment(parseInt(params.bid), parseInt(params.parent), params.userName, params.email, params.content, params.parentName, timeUtil.getNow(), timeUtil.getNow(), function (result) {
